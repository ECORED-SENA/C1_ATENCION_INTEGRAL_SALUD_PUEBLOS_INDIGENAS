...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
        .col-lg-6.d-flex 
          div.p-5.tema2-fondo-1(style="background-color:#E8A390")
    ...
    .row.mb-5
        .col-lg-6.d-flex 
          div.tema2-fondo-1.p-5(style="background-color:#EAAD9B")
        ...
        .col-lg-6.d-flex
          div.tema2-fondo-2.p-5(style="background-color:#C0C3B0")
    ...
    .fondo-especial2.py-5
      ...
      .row.justify-content-center
        .col-lg-10
          figure.mb-5 
            .video                      
              iframe(width="1255" height="706" src="https://www.youtube.com/embed/8wAgJhJgxqQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
