...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .tema-2
       PasosA.color-secundario.mb-0(tipo="n")
        .row
          .col-lg-12            
    ...
    .row.mb-5
        .col-lg-6.d-flex 
          div.p-5(style="background-color:#EAAD9B")
            h3.text-center.mb-5 Ley 21 de 1991
        ...
        .col-lg-6.d-flex
          div.p-5(style="background-color:#C0C3B0")
            h3.text-center.mb-5 Ley 691 de 2001
            .row.justify-content-center.align-items-center
              .col-lg-9
                figure.mb-5
                  img(src="@/assets/curso/tema2/img05.png")  
            p.mb-0 Reglamenta y garantiza el derecho de acceso y la participación de los Pueblos Indígenas en los Servicios de Salud, en condiciones dignas y apropiadas, observando el debido respeto y protección a la diversidad étnica y cultural de la nación.
    
    p.mb-5 Continuando con la Ley 691 de 2001, el acceso del derecho a la salud se hace teniendo en cuenta los siguientes principios: eficiencia, universalidad, solidaridad, integralidad, unidad, participación y el de diversidad étnica y cultural, en virtud del cual se establece un alcance especial a este derecho: “el sistema practicará la observancia y el respeto a su estilo de vida y tomará en consideración sus especificidades culturales y ambientales que permita un desarrollo armónico a los pueblos indígenas” (Artículo 3). El objeto de esta ley se ubica en su artículo dos:
    ...
    .row.mb-5
        .col-lg-6.d-flex 
          div.p-5(style="background-color:#EAAD9B")
            h3.text-center.mb-5 Decreto Nacional 4127 de 2005
            .row.justify-content-center.align-items-center
              .col-lg-9
                figure.mb-5
                  img(src="@/assets/curso/tema2/img07.png")  
            p.mb-0 Acreditó la prestación del servicio de salud por EPS Indígenas y la mesa de trabajo en salud indígena (Gobierno Nacional de Colombia, 2005); esto permitió, en principio, adecuar prácticas en salud tradicional con la implementación de programas de salud propia con atención a la embarazada, crecimiento y desarrollo, nutrición propia, promoción y prevención de las enfermedades desde la medicina ancestral (Osorio, 2019).
        .col-lg-6.d-flex
          div.p-5(style="background-color:#C0C3B0")
            h3.text-center.mb-5 Decreto 1953 de 2014
            .row.justify-content-center.align-items-center
              .col-lg-9
                figure.mb-5
                  img(src="@/assets/curso/tema2/img08.png")  
            p.mb-0 Por el cual se crea un régimen especial con el fin de poner en funcionamiento los Territorios Indígenas respecto de la administración de los sistemas propios de los pueblos indígenas, establece el Sistema Indígena de Salud Propio Intercultural (SISPI) (Ministerio del Interior- Presidencia de la República de Colombia, 2014).
    
    p.mb-5 A las anteriores reglamentaciones se suma el Sistema Indígena de Salud Propio e Intercultural - SISPI, el cual está pensado para implementarse desde diferentes cosmovisiones indígenas, para generar un sistema de salud acorde a sus necesidades, unificado para todos los pueblos, en el cual, se tenga en cuenta la relación de armonía y equilibrio de los recursos y las relaciones entre el conjunto de la comunidad y de ésta, con la naturaleza y los espíritus.
    
    .tema-2.mb-5
      .cajon.color-secundario.p-5
        p.mb-0 El SISPI se define como el conjunto de políticas, normas, principios, recursos, instituciones y procedimientos que se sustentan a partir de una concepción de vida colectiva, donde la sabiduría ancestral es fundamental para orientar dicho Sistema, en armonía con la madre tierra y según la cosmovisión de cada pueblo, se articula, coordina y complementa con el Sistema General de Seguridad Social en Salud (SGSSS), con el fin de maximizar los logros en salud de los pueblos indígenas.

    p.mb-5 <b>El SISPI</b> se adaptará a la cosmovisión y cosmogonía de cada pueblo indígena en Colombia; ellos definirán su implementación desde la salud propia, la interculturalidad, la gobernabilidad y autonomía en sus territorios. <b>Para ello se contemplan los siguientes artículos:</b> 

    .tema-2.mb-5
      LineaTiempoE.color-acento-contenido
        .row(titulo="Artículo 75" subtitulo="Principios que establece el SISPI:")
          .col-lg-12
        ...
        .row(titulo="Artículo 76" subtitulo="Concepto de salud propia:")
          .col-lg-12
        ...
        .row(titulo="Artículo 77" subtitulo="Componentes del Sistema Indígena de Salud Propio Intercultural (SISPI)")
          .col-lg-12
            ol.lista-ol.mb-5
              li 
                span.text-bold 
        ...
        .row(titulo="Artículo 83" subtitulo="Competencias en salud de los territorios indígenas.")
          .col-lg-12
        ...
        .row(titulo="Artículo 84" subtitulo="Estructuras propias del SISPI. ")
          .col-lg-12
        ...
        .row(titulo="Artículo 85" subtitulo="Financiación del SISPI en cada uno de sus componentes:")
          .col-lg-12            
              ...
              .tabla-a.color-secundario 
                table                  
                  thead
                    tr
                      th Componente
                      th Fuente de financiación                      
                  tbody
                    tr
                      td Sabiduría ancestral
                      td SGP-SGSSS
                    tr
        ...
        .row(titulo="Artículo 86" subtitulo="Financiamiento en la prestación de servicios. ")
          .col-lg-12
      ...
      .col-lg-6.px-5
        .row.align-items-center.mb-2
          .col-lg-2.d-flex.justify-content-end
            figure.tema-2-num.mb-0
              img(src="@/assets/curso/tema2/img10.svg")              
          .col-auto
            p.mb-0 Autonomía y libre auto-determinación.
        .row.align-items-center.mb-2
          .col-lg-2.d-flex.justify-content-end
            figure.tema-2-num.mb-0
              img(src="@/assets/curso/tema2/img11.svg")              
          .col-auto
            p.mb-0 Identidad cultural.
        .row.align-items-center.mb-2
          .col-lg-2.d-flex.justify-content-end
            figure.tema-2-num.mb-0
              img(src="@/assets/curso/tema2/img12.svg")              
          .col-auto
            p.mb-0 Reconocimiento de la diversidad étnica y cultural.
        .row.align-items-center.mb-2
          .col-lg-2.d-flex.justify-content-end
            figure.tema-2-num.mb-0
              img(src="@/assets/curso/tema2/img13.svg")              
          .col-auto
            p.mb-0 Territorialidad.
        .row.align-items-center.mb-2
          .col-lg-2.d-flex.justify-content-end
            figure.tema-2-num.mb-0
        ...
        .row.align-items-center.mb-2
          ...
          .col-auto
            p.mb-0 Interpretación cultural.      
      .col-lg-5
        figure.mb-0
